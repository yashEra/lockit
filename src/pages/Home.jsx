  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center pb-8">
        <p className="text-[16px] text-center text-[#555555] max-w-[1140px]">
      ...
      <MainTitle main="What Why Choose Us?" />

      <div className="flex flex-col items-center pb-8">
        <div className="text-[16px] text-center text-[#555555] max-w-[1140px] grid grid-cols-3 gap-4 pt-6">
          <FeaturesCard
            icon="icon-1.svg"
